...
import { getVendorFromMetadata } from "@/lib/marketplace";
import { VendorBadge } from "@/ui/components/vendor-badge";
...
async function ProductContent({
	...
	const vendor = getVendorFromMetadata(product.metadata);
				...
				<div className="grid gap-8 lg:grid-cols-2 lg:gap-16">
					...
					<div className="flex flex-col gap-3">
						...
						<div className="order-3">
							<VendorBadge vendor={vendor} channel={params.channel} />
						</div>
